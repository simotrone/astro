...
print('flux: {0:.4e} ph/cm²/s'.format(flux_eval_following_ctools([25e3, 150e6], m_spect['Prefactor'].value())))
my_eflux = eflux_eval_following_ctools([25e3, 150e6], m_spect['Prefactor'].value())
print('eflux: {0:.4e} MeV/cm²/s => {1:.4e} erg/cm²/s'.format(my_eflux, my_eflux*mev2erg))
